...
class ApiTestCase(unittest.TestCase):
    def setUp(self):
        print("******************start test******************")
        ##设置访问api接口信息
        self.url = 'http://api.nhbia.cn/v2_user/get_user_default_info?ysx_api_version=2.0'
        self.srcFile = 'en_data_api_get_user_default_info.txt'
        self.retFile = 'r_data_api_get_user_default_info.txt'
        ##设置配置文件目录信息

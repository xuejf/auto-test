...
class ApiTestCase(unittest.TestCase):
    def setUp(self):
        print("******************start test******************")
        ##设置访问api接口信息
        self.url = 'http://api.nhbia.cn/dis_shipping/insert_delivery?ysx_api_version=2.0'
        self.srcFile = 'en_api_insert_delivery.txt'
        self.retFile = 'r_api_insert_delivery.txt'
        ##设置配置文件目录信息

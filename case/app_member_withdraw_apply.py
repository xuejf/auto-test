...
class ApiTestCase(unittest.TestCase):
    def setUp(self):
        print("******************start test******************")
        ##设置访问api接口信息
        self.url = 'http://cs.86lezhi.com/appapi/index.php?act=member_withdraw&op=member_withdraw_apply'
        self.srcFile = 'data_app_member_withdraw_apply.txt'
        self.retFile = 'r_app_member_withdraw_apply.txt'
        ##设置配置文件目录信息
    ...
    def test_1(self):
      ...
      #  data = {'encrypt': en_str}
       # print(data)
        s_str = read_txt(self.inFile)
        urllib.parse.quote(s_str, safe='')
        data = s_str
        ...
        r_str = json.loads(res.text)
        writetxt(self.outFile, str(r_str))

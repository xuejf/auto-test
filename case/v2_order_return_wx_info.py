...
class ApiTestCase(unittest.TestCase):
    def setUp(self):
        print("******************start test******************")
        ##设置访问api接口信息
        self.url = 'http://api.wawa.com/v2_order/return_wx_info?ysx_api_version=2.0'
        self.srcFile = 'en_v2_order_return_wx_info.txt'
        self.retFile = 'r_v2_order_return_wx_info.txt'
        ##设置配置文件目录信息

...
class ApiTestCase(unittest.TestCase):
    def setUp(self):
        print("******************start test******************")
        ##设置访问api接口信息
        self.url = 'http://cs.86lezhi.com/appapi/index.php?act=member_withdraw&op=member_withdraw_list'
        self.srcFile = 'data_app_member_withdraw_list.txt'
        self.retFile = 'r_app_member_withdraw_list.txt'
        ##设置配置文件目录信息

...
class ApiTestCase(unittest.TestCase):
    def setUp(self):
        print("******************start test******************")
        ##设置访问api接口信息
        self.url = 'http://api.nhbia.net/v2_order/create_order?ysx_api_version=2.0'
        self.srcFile = 'en_v2_order_create_order.txt'
        self.retFile = 'r_v2_order_create_order.txt'
        ##设置配置文件目录信息

...
class ApiTestCase(unittest.TestCase):
    def setUp(self):
        print("******************start test******************")
        ##设置访问api接口信息
        self.url = 'http://cs.86lezhi.com/appapi/index.php?act=member_buy_s&op=fx_buy_step2'
        self.srcFile = 'data_app_fx_buy_step2.txt'
        self.retFile = 'r_app_fx_buy_step2.txt'
        ##设置配置文件目录信息
